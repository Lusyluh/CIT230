const apiURL = 'https://api.openweathermap.org/data/2.5/weather?id=5607916&APPID=cbd2cdfdd1f438f29af3417a193151ae&units=imperial';
...
fetch(apiURL)
    ...
    .then((cwObject) => {
        ...
        document.getElementById('temp').textContent = cwObject.main.temp_max.toFixed(0) + "°F";
        document.getElementById('windSpeed').textContent = cwObject.wind.speed.toFixed(1) + "mph";
...
const fivedayURL = 'https://api.openweathermap.org/data/2.5/forecast?id=5607916&APPID=cbd2cdfdd1f438f29af3417a193151ae&units=imperial';
